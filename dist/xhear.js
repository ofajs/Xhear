...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('stanz/src/public.mjs'), require('stanz/src/accessor.mjs'), require('stanz/src/watch.mjs'), require('stanz/src/base.mjs'), require('stanz/src/main.mjs')) :
  typeof define === 'function' && define.amd ? define(['stanz/src/public.mjs', 'stanz/src/accessor.mjs', 'stanz/src/watch.mjs', 'stanz/src/base.mjs', 'stanz/src/main.mjs'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.$ = factory(global.public_mjs, global.accessor_mjs, global.watchFn, global.stanz, global.Stanz));
})(this, (function (public_mjs, accessor_mjs, watchFn, stanz, Stanz) { 'use strict';

  const isFunction = (val) => public_mjs.getType(val).includes("function");
  ...
  const handler = {
    set(target, key, value, receiver) {
      ...
      return accessor_mjs.handler.set(target, key, value, receiver);
    },
...
`;
  ...
  const xifComponentOpts = {
    ...
    ready() {
      ...
      public_mjs.nextTick(() => this.ele.remove());
    },
  };
    ...
    watch: {
      value(val) {
        ...
        if (!(val instanceof Array)) {
          console.warn(
            `The value of x-fill component must be of type Array, and the type of the current value is ${public_mjs.getType(
            val
          )}`
          );
  ...
  class Xhear extends LikeArray {
    constructor({ ele }) {
      ...
      const proxySelf = Stanz.constructor.call(this, {}, handler);
    ...
    extend(obj, desc) {
      return public_mjs.extend(this, obj, desc);
    }
    ...
    set style(d) {
      if (public_mjs.getType(d) == "string") {
        this.ele.style = d;
        return;
      }
  ...
  const createXEle = (expr, exprType) => {
    ...
    const type = public_mjs.getType(expr);
  ...
  function $(expr) {
    if (public_mjs.getType(expr) === "string" && !/<.+>/.test(expr)) {
