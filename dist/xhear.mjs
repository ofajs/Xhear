...
import { getType, nextTick, extend } from 'stanz/src/public.mjs';
import { handler as handler$1 } from 'stanz/src/accessor.mjs';
import watchFn, { emitUpdate } from 'stanz/src/watch.mjs';
